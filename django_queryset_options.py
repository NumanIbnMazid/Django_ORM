...
class _QuerySet(Generic[_T, _Row], Collection[_Row], Reversible[_Row], Sized):
    ...
    def bulk_update(self, objs: Iterable[_T], fields: Sequence[str],
                    batch_size: Optional[int] = ...) -> None: ...

    def get_or_create(
        self, defaults: Optional[MutableMapping[str, Any]] = ..., **kwargs: Any) -> Tuple[_T, bool]: ...
    ...
    def earliest(self, *fields: Any,
                 field_name: Optional[Any] = ...) -> _Row: ...
    def latest(self, *fields: Any,
               field_name: Optional[Any] = ...) -> _Row: ...

    def first(self) -> Optional[_Row]: ...
    def last(self) -> Optional[_Row]: ...
    def in_bulk(self, id_list: Iterable[Any] = ...,
                *, field_name: str = ...) -> Dict[Any, _T]: ...

    def delete(self) -> Tuple[int, Dict[str, int]]: ...
    def update(self, **kwargs: Any) -> int: ...
    def exists(self) -> bool: ...

    def explain(self, *, format: Optional[Any]
                = ..., **options: Any) -> str: ...
    ...
    def values(self, *fields: Union[str, Combinable], **
               expressions: Any) -> _QuerySet[_T, Dict[str, Any]]: ...
    ...
    def dates(self, field_name: str, kind: str,
              order: str = ...) -> _QuerySet[_T, datetime.date]: ...
...
class RawQuerySet(Iterable[_T], Sized):
    ...
    def resolve_model_init_order(self) -> Tuple[List[str],
...
class Prefetch(object):
    def __init__(self, lookup: str,
                 queryset: Optional[QuerySet] = ..., to_attr: Optional[str] = ...) -> None: ...
...
def prefetch_related_objects(
    model_instances: Iterable[_T], *related_lookups: Union[str, Prefetch]) -> None: ...


def get_prefetcher(instance: Model, through_attr: str,
                   to_attr: str) -> Tuple[Any, Any, bool, bool]: ...
